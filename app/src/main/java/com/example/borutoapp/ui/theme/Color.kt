...
val Colors.statusBarColor
    @Composable get() = if (isLight) Purple700 else Color.Black
...
val Colors.activeIndicatorColor
    @Composable get() = if (isLight) Purple500 else Purple700
...
val Colors.topAppBarBackgroundColor
    @Composable get() = if (isLight) Purple500 else Color.Black
